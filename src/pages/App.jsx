...
const App = () => {
  ...
  const listTitleChange = (title, listId) => {
  ...
  const cardTitleChange = (cardId, listId, title) => {
  ...
  const addMoreCard = (listId, newCardTitle) => {
    ...
    const newState = {
      ...
      lists: {
        ...data.lists,
        /* eventhough we copied all lists including one we want to update,
           our updated list will override it because of the nature of objects. */
        [listId]: updatedList,
      },
    };
    setData(newState);
